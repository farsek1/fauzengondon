...
local function StartWalkingLoop()
    ...
    walkConnection = game:GetService("RunService").Heartbeat:Connect(function()
        ...
        local currentIndex = _G.currentWalkIndex or 1
        ...
        if targetPos then
            ...
            if rootPart then
                ...
                if distance < 5 then -- Увеличил дистанцию для более плавного перехода
                    _G.currentWalkIndex = (currentIndex % #_G.walkPts) + 1
                end
            end
        end
    end)
